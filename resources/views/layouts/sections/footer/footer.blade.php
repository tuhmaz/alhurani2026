    ...
    <div class="footer-container d-flex align-items-center justify-content-between py-3">
      <div>
        ...
        <span class="footer-version ms-3 text-muted">
          <i class="footer-icon tabler-info-circle me-1"></i>
          {{ config('settings.version', 'v2.0.0') }}
        </span>
      </div>

      <div class="d-none d-sm-inline-block">
        <div class="footer-utils">
          <a href="{{ route('dashboard.documentation') }}" class="footer-link me-4" data-bs-toggle="tooltip" data-bs-placement="top" title="التوثيق">
            <i class="footer-icon tabler-book me-1"></i>
            <span class="d-none d-md-inline">التوثيق</span>
          </a>
          <a href="{{ route('dashboard.support') }}" class="footer-link me-4" data-bs-toggle="tooltip" data-bs-placement="top" title="الدعم الفني">
            <i class="footer-icon tabler-help me-1"></i>
          ...
          <a href="#" class="footer-link" data-bs-toggle="modal" data-bs-target="#shortcutsModal">
            <i class="footer-icon tabler-keyboard me-1"></i>
