...
<div class="container px-4 mt-4">
    <ol class="breadcrumb breadcrumb-style2" aria-label="breadcrumbs">
        <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="home-icon ti tabler-home-check"></i>{{ __('Home') }}</a></li>
                        ...
                        <div class="p-4 pb-0 pe-lg-0 pt-lg-4 align-items-center rounded-3 border shadow-lg">
                            <div class="text-center p-3 p-lg-4 pt-lg-3">
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-3 mt-4">
                                    ...
                                    <a href="{{ route('frontend.subject.articles', ['database' => $database ?? session('database'),'subject' => $subject->id, 'semester' => $semester->id, 'category' => 'records']) }}" class="btn btn-outline-info">{{ __('Records') }}</a>
                                </div>
                                @endforeach
                            </div>
                        </div>
...
<!-- Subject Ad: placed after main content to avoid above-the-fold -->
<div class="container mt-4 mb-4">
    <x-adsense.banner desktop-key="google_ads_desktop_subject" mobile-key="google_ads_mobile_subject" />
</div>
@endsection
