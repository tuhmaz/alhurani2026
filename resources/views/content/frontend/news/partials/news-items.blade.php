@foreach(($posts ?? $news) as $newsItem)
<div class="col-md-6 col-lg-3 mb-4">
    <div class="card h-100 shadow-sm d-flex flex-column">
        ...
        <div class="card-body d-flex flex-column">
            ...
            <div class="mt-auto">
                <a href="{{ route('content.frontend.posts.show', ['database' => session('database', 'jo'), 'id' => $newsItem->id]) }}" class="btn btn-primary btn-sm">Read More</a>
            </div>
        </div>
