          ...
          @guest
            ...
            <div class="d-flex justify-content-center gap-3 animate__animated animate__fadeInUp animate__delay-1s">
              <a href="{{ route('login') }}" class="btn btn-primary btn-lg"
                ...
                <i class="user-icon ti tabler-user-plus me-2"></i>{{ __('Get Started') }}
              </a>
              <a href="#features" class="btn btn-outline-light btn-lg">
                <i class="info-icon ti tabler-info-circle me-2"></i>{{ __('Learn More') }}
              </a>
            </div>
          @endguest
        </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-12">
            <div class="d-flex align-items-center mb-4">
              <i class="article-icon ti tabler-article text-primary me-2" style="font-size: 2rem;"></i>
                    ...
                    <div class="position-relative">
                      ...
                      @else
                        <div class="bg-light text-center py-5">
                          <i class="article-icon ti tabler-article text-primary" style="font-size: 3rem;"></i>
                        </div>
                      @endif
                    ...
                    <div class="card-footer bg-transparent border-top-0">
                      <div class="d-flex justify-content-between align-items-center">
                        <a href="{{ route('frontend.articles.show', ['database' => $database, 'article' => $article->id]) }}"
                          ...
                          <i class="eye-icon ti tabler-eye me-1"></i>{{ __('Read More') }}
                        </a>
                        <small class="text-muted">
                          <i
                            class="calendar-icon ti tabler-calendar me-1"></i>{{ $article->created_at->format('Y-m-d') }}
                        </small>
                      </div>
                    </div>
                  </div>
      ...
      @if ($files && $files->count() > 0)
        <div class="row">
          <div class="col-12">
            <div class="d-flex align-items-center mb-4">
              <i class="file-icon ti tabler-files text-primary me-2" style="font-size: 2rem;"></i>
              <h3 class="mb-0">{{ __('Files') }}</h3>
            </div>
            <div class="container mt-4 mb-4">
              <x-adsense.banner desktop-key="google_ads_desktop_classes_2" mobile-key="google_ads_mobile_classes_2" />
            </div>
            <div class="row g-4">
                  ...
                  <div class="card h-100 shadow-sm hover-elevate-up">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        ...
                        @endphp
                        <i class="file-icon ti tabler-{{ $fileIcon }} text-primary me-2"
                      ...
                      <div class="mt-3">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                          <span class="badge bg-light text-dark">
                            <i class="ruler-icon ti tabler-ruler me-1"></i>
                            {{ number_format($file->file_size / 1024 / 1024, 2) }} MB
                          </span>
                          <span class="badge bg-light text-dark">
                            <i class="calendar-icon ti tabler-calendar me-1"></i>
                        ...
                        <a href="{{ route('download.page', ['file' => $file->id, 'database' => $database]) }}"
                          ...
                          <i class="download-icon ti tabler-download me-2"></i>{{ __('Download') }}
                        </a>
                      </div>
                    </div>
                  </div>
      ...
      @if (!$articles->count() && !$files->count())
        <div class="text-center py-5">
          <div class="mb-4">
            <i class="search-icon ti tabler-search-off" style="font-size: 4rem; color: #6c757d;"></i>
          </div>
          <h3>{{ __('No Results Found') }}</h3>
          <p class="text-muted">{{ __('Try different search terms or browse our categories') }}</p>
          <a href="{{ route('home') }}" class="btn btn-primary mt-3">
            <i class="home-icon ti tabler-home me-2"></i>{{ __('Back to Home') }}
          </a>
        </div>
      @endif
    </div>
