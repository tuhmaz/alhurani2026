        ...
        <div class="stat-card">
            <div class="d-flex align-items-center">
                <div class="stat-icon bg-primary bg-opacity-10 text-primary">
                    <i class="security-icon ti tabler-shield"></i>
                </div>
                <div>
        ...
        <div class="stat-card">
            <div class="d-flex align-items-center">
                <div class="stat-icon bg-danger bg-opacity-10 text-danger">
                    <i class="security-icon ti tabler-alert-triangle"></i>
                </div>
                <div>
        ...
        <div class="stat-card">
            <div class="d-flex align-items-center">
                <div class="stat-icon bg-warning bg-opacity-10 text-warning">
                    <i class="security-icon ti tabler-clock"></i>
                </div>
                <div>
        ...
        <div class="stat-card">
            <div class="d-flex align-items-center">
                <div class="stat-icon bg-info bg-opacity-10 text-info">
                    <i class="security-icon ti tabler-ban"></i>
                </div>
                <div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="badge rounded-pill me-2" style="background-color: var(--bs-{{ $log->event_type_color }})">
                                            <i class="page-icon ti tabler-{{ $log->event_type === 'login_failed' ? 'x' : 'check' }}"></i>
                                        </span>
