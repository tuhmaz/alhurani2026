            ...
            <form id="analytics-filter" class="row g-3">
                ...
                <div class="col-12 col-md-2 d-flex align-items-end">
                    <button type="submit" class="btn btn-primary w-100">
                        <i class="security-icon ti tabler-filter me-1"></i>
                        {{ __('Apply') }}
                    </button>
                </div>
            </form>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @if($scoreChange > 0)
                            <small class="text-success">
                                <i class="security-icon ti tabler-trending-up"></i> +{{ $scoreChange }}%
                            </small>
                        @elseif($scoreChange < 0)
                            <small class="text-danger">
                                <i class="security-icon ti tabler-trending-down"></i> {{ $scoreChange }}%
                            </small>
                        @endif
                    </div>
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="badge bg-label-primary">{{ strtoupper($country->country_code) }}</span>
                                            <small class="text-muted">{{ $country->city }}</small>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
