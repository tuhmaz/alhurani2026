        ...
        <div class="row">
          <div class="col-md-6">
            <div class="btn-group">
              ...
              <button type="button" class="btn btn-outline-secondary {{ request('category') === 'records' ? 'active' : '' }}"
                      onclick="window.location.href='{{ route('dashboard.files.index', ['country' => $country, 'category' => 'records']) }}'">
                {{ __('Records') }}
              </button>
            </div>
          </div>
            ...
            <div class="d-flex justify-content-between align-items-center">
              <form action="{{ route('dashboard.files.index', ['country' => $country]) }}" method="GET" class="article-search-form flex-grow-1 me-3">
                <div class="input-group">
                  <span class="input-group-text"><i class="file-icon ti tabler-search"></i></span>
                  <input type="text"
                         class="form-control"
                         name="search"
              ...
              <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#updateFileModal">
                <i class="file-icon ti tabler-file-upload me-1"></i>{{ __('Update File') }}
              </button>
            </div>
          </div>
        </div>
                  ...
                  <div class="d-flex align-items-center">
                    @php
                      $iconClass = match($file->file_type) {
                        'pdf' => 'ti tabler-file-text',
                        'doc', 'docx' => 'ti tabler-file-description',
                        'xls', 'xlsx' => 'ti tabler-file-spreadsheet',
                        'jpg', 'jpeg', 'png', 'gif' => 'ti tabler-photo',
                        default => 'ti tabler-file'
                      };
                    @endphp
                ...
                <td>
                  <div class="d-flex gap-2">
                    <a href="{{ route('dashboard.files.show', ['file' => $file->id, 'country' => $country]) }}"
                       ...
                       title="{{ __('View') }}">
                      <i class="file-icon ti tabler-eye"></i>
                    </a>
                    <form action="{{ route('dashboard.files.download', ['file' => $file->id, 'country' => $country]) }}"
                      ...
                      <button type="submit"
                              class="btn btn-sm btn-icon btn-text-secondary"
                              title="{{ __('Download') }}">
                        <i class="file-icon ti tabler-download"></i>
                      </button>
                    </form>
                    <form action="{{ route('dashboard.files.destroy', ['file' => $file->id, 'country' => $country]) }}"
                      ...
                      <button type="button"
                        ...
                        <i class="file-icon ti tabler-trash text-danger"></i>
                      </button>
                    </form>
                    <button type="button" class="btn btn-sm btn-icon btn-text-secondary update-file-btn"
                      ...
                      <i class="file-icon ti tabler-edit"></i>
                    </button>
                  </div>
                </td>
              </tr>
              ...
              <tr>
                <td colspan="6" class="text-center py-4">
                  <div class="text-center">
                    <i class="file-icon ti tabler-file-off mb-2" style="font-size: 3rem;"></i>
        ...
        <form id="updateFileForm" action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="alert alert-info mb-3">
            <div class="d-flex align-items-center mb-2">
              <i class="file-icon ti tabler-info-circle me-2"></i>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-12">
              ...
              <div id="selected-file-info" class="alert alert-primary d-none mt-2">
                <div class="d-flex align-items-center">
                  <i class="file-icon ti tabler-file me-2"></i>
