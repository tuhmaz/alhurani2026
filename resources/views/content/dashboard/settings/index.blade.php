        ...
        <div class="nav-align-top">
          ...
          <div class="tab-content">
              ...
              <form id="generalSettingsForm" class="settings-form" action="{{ route('dashboard.settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="file" class="form-control" name="site_logo" accept="image/*,image/webp,.webp">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="file" class="form-control" name="site_favicon" accept="image/*,image/webp,.webp">
            ...
            <div class="tab-pane fade" id="appearance" role="tabpanel">
              <form id="appearanceSettingsForm" class="settings-form" action="{{ route('dashboard.settings.update') }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-md-6 mb-3">
            ...
            <div class="tab-pane fade" id="security" role="tabpanel">
              <form id="securitySettingsForm" class="settings-form" action="{{ route('dashboard.settings.update') }}" method="POST">
                @csrf
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
              ...
              <form id="adsSettingsForm" class="settings-form" action="{{ route('dashboard.settings.update') }}" method="POST">
                ...
                <div class="row">
                  <div class="col-12 mb-3">
                    <label class="form-label">{{ __('AdSense Client ID (ca-pub-...)') }}</label>
                    <input type="text" class="form-control" name="adsense_client" value="{{ $settings['adsense_client'] ?? '' }}" placeholder="ca-pub-xxxxxxxxxxxxxxxx" />
                    <small class="text-muted d-block mt-1">
                      {{ __('This enables the global AdSense script. Example: ca-pub-3261107836376906') }}
                    </small>
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-md-6 mb-3">
                    <label class="form-label">{{ __('News Page Ad 1') }}</label>
                    <textarea class="form-control" name="google_ads_desktop_news" rows="3">{{ $settings['google_ads_desktop_news'] }}</textarea>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label class="form-label">{{ __('News Page Ad 2') }}</label>
                    <textarea class="form-control" name="google_ads_desktop_news_2" rows="3">{{ $settings['google_ads_desktop_news_2'] }}</textarea>
                  </div>
                  <div class="col-md-6 mb-3">
                  ...
                  <div class="col-md-6 mb-3">
                    <label class="form-label">{{ __('News Page Ad 1 (Mobile)') }}</label>
                    <textarea class="form-control" name="google_ads_mobile_news" rows="3">{{ $settings['google_ads_mobile_news'] }}</textarea>
                  </div>
                  <div class="col-md-6 mb-3">
                    <label class="form-label">{{ __('News Page Ad 2 (Mobile)') }}</label>
                    <textarea class="form-control" name="google_ads_mobile_news_2" rows="3">{{ $settings['google_ads_mobile_news_2'] }}</textarea>
                  </div>
                  <div class="col-md-6 mb-3">
              ...
              <form id="recaptchaSettingsForm" class="settings-form" action="{{ route('dashboard.settings.update') }}" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="password" class="form-control" name="recaptcha_secret_key" value="{{ $settings['recaptcha_secret_key'] ?? '' }}">
                    <small class="text-muted">{{ __('Your reCAPTCHA secret key') }}</small>
                  </div>
                  <div class="col-12">
                    <div class="alert alert-info">
                      <i class="bx bx-info-circle me-1"></i>
                      {{ __('Current reCAPTCHA configuration:') }}
                      <ul class="mt-2 mb-0">
                        <li>{{ __('Site Key:') }} {{ $settings['recaptcha_site_key'] ?? config('captcha.sitekey') }}</li>
                        <li>{{ __('Secret Key:') }} {{ ($settings['recaptcha_secret_key'] ?? config('captcha.secret')) ? '***********' : '' }}</li>
                      </ul>
                    </div>
                  </div>
                </div>
