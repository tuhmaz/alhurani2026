    ...
    <div class="card mt-4">
        <div class="card-body">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-primary">
                            <i class="page-icon ti tabler-refresh me-1"></i>توليد خريطة الموقع
                        </button>
                    </div>
                </div>
            </form>
            ...
            <div class="alert alert-info mt-3">
                <div class="d-flex">
                    <i class="page-icon ti tabler-info-circle me-2 fs-3"></i>
                    <div>
