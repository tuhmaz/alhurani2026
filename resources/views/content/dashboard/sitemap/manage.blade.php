                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('dashboard.articles.show', ['article' => $article->id]) }}"
                        ...
                        <i class="page-icon ti tabler-external-link"></i>
                      </a>
                    </td>
                  </tr>
                  @endforeach
