                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('dashboard.school-classes.edit', $class) }}" class="btn btn-primary">
                            <i class="school-icon ti tabler-edit me-1"></i>{{ __('Edit Class') }}
                        </a>
                        <form action="{{ route('dashboard.school-classes.destroy', $class) }}"
                            ...
                            <button type="submit" class="btn btn-danger">
                                <i class="school-icon ti tabler-trash me-1"></i>{{ __('Delete Class') }}
                            </button>
                        </form>
                    </div>
                </div>
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="{{ route('dashboard.subjects.create', ['class_id' => $class->id]) }}"
                                           class="btn btn-outline-primary">
                                            <i class="school-icon ti tabler-plus me-1"></i>
                                            {{ __('Add New Subject') }}
                                        </a>
                                        <a href="{{ route('dashboard.school-classes.index') }}"
                                           class="btn btn-outline-secondary">
                                            <i class="school-icon ti tabler-arrow-left me-1"></i>
                                            {{ __('Back to Classes') }}
                                        </a>
                                    </div>
                                </div>
