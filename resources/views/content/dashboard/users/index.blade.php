...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <button type="button" id="delete-selected" class="btn btn-danger d-none">
            <i class="user-icon ti tabler-trash me-1"></i>{{ __('Delete Selected') }}
        </button>
        <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('dashboard.users.create') }}'">
            <i class="user-icon ti tabler-plus me-1"></i>{{ __('Add User') }}
        </button>
        @endcan
    </div>
</div>
        ...
        <form id="filterForm" class="row g-3"
            ...
            <div class="col-md-5">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="user-icon ti tabler-search"></i></span>
            ...
            <div class="col-md-2 d-flex align-items-end">
                <button type="button" id="resetFiltersBtn" class="btn btn-secondary w-100">
                    <i class="user-icon ti tabler-refresh me-1"></i>{{ __('Reset') }}
                </button>
            </div>
        </form>
    </div>
