            ...
            <div class="d-flex flex-column flex-md-row justify-content-between gap-3">
                ...
                <div>
                    <a href="{{ route('dashboard.subjects.create', ['country_id' => $selectedCountry]) }}" class="btn btn-primary">
                        <i class="Subject-icon ti tabler-plus me-1"></i>
                        {{ __('Add New Subject') }}
                    </a>
                </div>
            </div>
        ...
        <div class="card-body">
            @if($hasError && $errorMessage)
                <div class="alert alert-warning" role="alert">
                    <i class="Subject-icon ti tabler-alert-triangle me-2"></i>
                    {{ $errorMessage }}
                </div>
            @endif
                            ...
                            <h2 class="accordion-header">
                                <button class="accordion-button {{ $loop->first ? '' : 'collapsed' }}" type="button"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center w-100 me-3">
                                        <div>
                                            <i class="Subject-icon ti tabler-school me-2"></i>
                                            {{ $group['grade_name'] }}
                                        </div>
                                            ...
                                            <div class="list-group-item subject-item">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <div>
                                                            <h6 class="mb-0">
                                                                <i class="Subject-icon ti tabler-book me-2 text-primary"></i>
                                                                {{ $subject->subject_name }}
                                                            </h6>
                                                            <small class="text-muted">
                                                                <i class="Subject-icon ti tabler-calendar-event me-1"></i>
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <a href="{{ route('dashboard.subjects.show', ['subject' => $subject->id, 'country_id' => $selectedCountry]) }}"
                                                           ...
                                                           title="{{ __('View Details') }}">
                                                            <i class="Subject-icon ti tabler-eye"></i>
                                                        </a>
                                                        <a href="{{ route('dashboard.subjects.edit', ['subject' => $subject->id, 'country_id' => $selectedCountry]) }}"
                                                           ...
                                                           data-bs-toggle="tooltip"
                                                           title="{{ __('Edit') }}">
                                                            <i class="Subject-icon ti tabler-edit"></i>
                                                        </a>
                                                        <form action="{{ route('dashboard.subjects.destroy', ['subject' => $subject->id, 'country_id' => $selectedCountry]) }}"
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                <i class="Subject-icon ti tabler-trash"></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                </div>
