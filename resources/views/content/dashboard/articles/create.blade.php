  ...
  <div class="content-body">
    <div class="container-fluid">
      <div class="card">
        ...
        <div class="card-body">
          <form id="articleForm" action="{{ route('dashboard.articles.store', ['country' => $country]) }}" method="POST"
            ...
            <div class="mb-3">
              <div class="form-check form-switch">
                ...
                <small
                  class="form-text text-muted d-block">{{ __('If checked, the article will be published immediately after creation.') }}</small>
              ...
              <button type="submit" class="btn btn-success"><i
                  class="ri-save-line me-1"></i>{{ __('Submit') }}</button>
              <a href="{{ route('dashboard.articles.index', ['country' => $country]) }}"
