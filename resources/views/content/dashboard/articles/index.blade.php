        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
          ...
          <div class="d-flex header-actions gap-3 align-items-center">
            ...
            <a href="{{ route('dashboard.articles.create', ['country' => $country]) }}"
              ...
              <i class="artical-icon ti tabler-plus me-1"></i>{{ __('Add New Article') }}
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="stats-icon bg-label-primary">
            <i class="article-icon ti tabler-article text-primary"></i>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="stats-icon bg-label-info">
            <i class="artical-icon ti tabler-check text-info"></i>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="stats-icon bg-label-warning">
            <i class="artical-icon ti tabler-pencil text-warning"></i>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="stats-icon bg-label-success">
            <i class="artical-icon ti tabler-files text-success"></i>
          </div>
        </div>
      </div>
    </div>
...
<div class="floating-action-button">
  <a href="{{ route('dashboard.articles.create', ['country' => $country]) }}"
    ...
    <i class="artical-icon ti tabler-plus"></i>
  </a>
</div>
...
<div class="alert alert-success alert-dismissible animate__animated animate__fadeIn" role="alert">
  <div class="d-flex">
    <i class="article-icon ti tabler-check-circle me-2"></i>
...
<div class="alert alert-danger alert-dismissible animate__animated animate__fadeIn" role="alert">
  <div class="d-flex">
    <i class="article-icon ti tabler-alert-circle me-2"></i>
          ...
          <tr>
            <td>
              <div class="d-flex align-items-center">
                <i class="article-icon ti tabler-article text-primary me-2"></i>
                <div>
              ...
              <div class="d-flex flex-wrap gap-1">
                @forelse ($article->files as $file)
                  <span class="badge bg-label-info keyword-badge" title="{{ $file->file_name }}">
                    <i class="article-icon ti tabler-file me-1"></i>{{ $file->file_category }}
                  </span>
                @empty
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item text-danger delete-article" href="#"
                    ...
                    <i class="article-icon ti tabler-trash me-1"></i>{{ __('Delete') }}
                  </a>
                </div>
              </div>
            </td>
          ...
          <tr>
            <td colspan="8" class="text-center py-5">
              <div class="text-center">
                <i class="article-icon ti tabler-article-off mb-2" style="font-size: 3rem;"></i>
                <h6 class="mt-2">{{ __('No Articles Found') }}</h6>
                <p class="text-muted mb-3">{{ __('Start by adding your first article') }}</p>
                <a href="{{ route('dashboard.articles.create', ['country' => $country]) }}"
                   class="btn btn-primary">
                  <i class="article-icon ti tabler-plus me-1"></i>{{ __('Add New Article') }}
                </a>
              </div>
            </td>
          </tr>
