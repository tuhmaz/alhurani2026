    ...
    <div class="row mb-5">
            ...
            <div class="card h-100 shadow-sm border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        <i class="about-icon ti tabler-eye fs-3 text-primary me-2"></i>
        ...
        <div class="col-md-6">
            <div class="card h-100 shadow-sm border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
                        <i class="about-icon ti tabler-target fs-3 text-primary me-2"></i>
    ...
    <div class="card shadow-sm border-0 mb-5">
        <div class="card-body p-4">
            <div class="d-flex align-items-center mb-4">
                <i class="about-icon ti tabler-gift fs-3 text-primary me-2"></i>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="d-flex">
                        <i class="about-icon ti tabler-school fs-4 text-primary me-2"></i>
                        <div>
                ...
                <div class="col-md-6">
                    <div class="d-flex">
                        <i class="about-icon ti tabler-books fs-4 text-primary me-2"></i>
                        <div>
                ...
                <div class="col-md-6">
                    <div class="d-flex">
                        <i class="about-icon ti tabler-news fs-4 text-primary me-2"></i>
                        <div>
                ...
                <div class="col-md-6">
                    <div class="d-flex">
                        <i class="about-icon ti tabler-filter fs-4 text-primary me-2"></i>
                        <div>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4">
                        <i class="about-icon ti tabler-heart fs-3 text-primary me-2"></i>
                        <h2 class="h4 mb-0">{{ __('قيمنا') }}</h2>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="d-flex">
                                <i class="about-icon ti tabler-award fs-4 text-primary me-2"></i>
                                <div>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <i class="about-icon ti tabler-users fs-4 text-primary me-2"></i>
                                <div>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex">
                                <i class="about-icon ti tabler-bulb fs-4 text-primary me-2"></i>
                                <div>
