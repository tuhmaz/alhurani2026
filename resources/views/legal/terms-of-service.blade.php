            ...
            <div class="col-12 col-lg-8 text-center">
                ...
                <div class="d-flex justify-content-center gap-3 animate__animated animate__fadeInUp animate__delay-1s">
                    <a href="{{ route('login') }}" class="btn btn-primary btn-lg" style="background: linear-gradient(45deg, #3498db, #2980b9); border: none; box-shadow: 0 4px 15px rgba(52, 152, 219, 0.3);">
                        <i class="terms-icon ti tabler-user-plus me-2"></i>{{ __('Get Started') }}
                    </a>
                    <a href="#features" class="btn btn-outline-light btn-lg">
                        <i class="terms-icon ti tabler-info-circle me-2"></i>{{ __('Learn More') }}
                    </a>
                </div>
                @endguest
            </div>
            ...
            <ol class="breadcrumb breadcrumb-style2">
                <li class="breadcrumb-item">
                    <a href="{{ route('home') }}" class="text-decoration-none">
                        <i class="terms-icon ti tabler-home-check"></i> {{ __('Home') }}
                    </a>
                </li>
    ...
    <h2 class="h4 mb-0">{{ __('التواصل معنا') }}</h2>
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="d-flex align-items-center">
                        <i class="terms-icon ti tabler-mail fs-4 text-primary me-2"></i>
                    ...
                    <div class="d-flex align-items-center">
                        <i class="terms-icon ti tabler-world fs-4 text-primary me-2"></i>
