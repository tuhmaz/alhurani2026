  ...
  if (dt_projects_table.length) {
    var dt_project = dt_projects_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="page-icon ti tabler-dots-vertical ti-md"></i></a>' +
      ...
      language: {
        ...
        paginate: {
          next: '<i class="page-icon ti tabler-chevron-right ti-sm"></i>',
          previous: '<i class="page-icon ti tabler-chevron-left ti-sm"></i>'
        }
      },
      responsive: {
        details: {
