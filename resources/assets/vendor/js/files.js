  ...
  tr.innerHTML = `
    <td>
      <div class="d-flex align-items-center">
        <i class="page-icon ti tabler-${getFileIcon(file.extension)} text-primary me-2" style="font-size: 1.5rem;"></i>
        <div>
    ...
    <td>
      <span class="text-muted"><i class="page-icon ti tabler-calendar me-1"></i>${formatDate(file.created_at)}</span>
    </td>
    <td>
