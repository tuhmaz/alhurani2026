...
class SecurityLogController extends Controller
{
    ...
    public function index()
    {
        ...
        $recentLogs = SecurityLog::with('user')
            ...
            ->get()
            ->map(function ($log) {
                // Use controller helper to compute color; model accessor does not exist
    ...
    public function analytics(Request $request)
    {
        ...
        $geoDistribution = SecurityLog::whereBetween('created_at', [$startDate, $endDate])
            ...
            ->select(
                ...
                DB::raw("SUM(CASE WHEN event_type = 'blocked_access' THEN 1 ELSE 0 END) as blocked_ips_count")
            )
